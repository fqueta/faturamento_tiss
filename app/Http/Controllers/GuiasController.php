    ...
    public function campos($sec = false){
        ...
        if($this->url=='internacao'){
            ...
            $arr_Paineldespesas = [
                ...
                'despesas[anvisa]'  =>['label'=>'Registro ANVISA do material','id'=>'despesa_alimentador_anvisa','active'=>false,'placeholder'=>'','type'=>'text_upcase','exibe_busca'=>'d-block','class'=>'','event'=>'maxlength=15','tam'=>'4','cp_busca'=>'','title'=>'Condicionado. Deve ser preenchido em caso de cobrança de órteses, próteses e materiais especiais, quando for utilizado código de material ainda não cadastrado na TUSS.'],
                ...
                'despesas[autorizacao]'  =>['label'=>'Autorização de funcionamento','id'=>'despesa_alimentador_autorizacao','active'=>false,'placeholder'=>'','type'=>'text_upcase','exibe_busca'=>'d-block','class'=>'','event'=>'maxlength=30','tam'=>'4','cp_busca'=>'','title'=>'Condicionado. Deve ser preenchido em caso de cobrança de órteses, próteses e materiais especiais que foram adquiridos
            ...
            return [
                ...
                'config[nomeContratado]'=>['label'=>'14-Nome do Contratado','active'=>false,'placeholder'=>'','type'=>'text_upcase','exibe_busca'=>'d-block','event'=>'required maxlength=70','tam'=>'7','cp_busca'=>'config][nomeContratado','title'=>'Razão Social, nome fantasia ou nome do prestador contratado da operadora que executou oprocedimento.'],
