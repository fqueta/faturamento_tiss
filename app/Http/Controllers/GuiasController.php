    ...
    public function campos($sec = false){
        ...
        if($this->url=='internacao'){
            return [
                ...
                'config[data_autorizacao]'=>['label'=>'4-Data da Autorização','active'=>false,'placeholder'=>'','type'=>'date','exibe_busca'=>'d-block','event'=>'','tam'=>'3','cp_busca'=>'config][data_autorizacao',],
                ...
                'config[dataValidadeSenha]'=>['label'=>'6-Data de Validade da Senha','active'=>false,'placeholder'=>'','type'=>'date','exibe_busca'=>'d-block','event'=>'required','tam'=>'3','cp_busca'=>'config][dataValidadeSenha',],
