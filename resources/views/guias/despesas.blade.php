...
.celula_item {
    ...
    <div class="card">
                    ...
                    <table width="100%" class="px-0">
                        <tbody>
                            <tr>
                                ...
                                <td class="celula_item" align="center" width="65">Tipo</td>
                        ...
                        <tbody class="list-despesass" id="demo_despesas">
                            @php
                            ...
                            @if (isset($arr_list['despesas']) && is_array($arr_list['despesas']))
                                ...
                                @foreach ($arr_list['despesas'] as $k=>$vt)
                                    @php
                                        ...
                                        $arr_campos = ['tipo','data','hora1','hora2','anvisa','fabricante','autorizacao','tabela','codigo','descricao','quantidade','fator','valor_unitario','valor_total'];
                                    ...
                                    @endphp
                                    <tr id="tr_despesa_linha_{{@$vt['item']}}" style="cursor: pointer" title="DOIS CLIQUES PARA EDITAR" ondblclick="editarProcedimento('{{@$vt['item']}}')" onmouseover="btnEdit(this)" onmouseout="btnEdit(this,'oc')">
                                        ...
                                        <td class="celula_item" align="center" width="30">
                                            <button type="button" class="btn btn-outline-danger" title="{{__('Remover')}}" onclick="despesas_remove_item('{{@$vt['item']}}','{{@$vt['tipo']}}')">
        ...
        <div class="card-footer text-right">
            <button type="button" title="" class="btn btn-outline-primary" data-toggle="modal" onclick="telaAdicionarProcedimentos()" data-target="#add-despesas">
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btn-add-despesas" class="btn btn-primary" onclick="alimenta_despesas()" title="{{__('Adicionar despesas nesta guia')}}"><i class="fas fa-plus"></i> {{__('Adicionar')}}</button>
                <button type="button" id="btn-upd-despesas" class="btn btn-primary" style="display: none;" onclick="alimenta_despesas()" title="{{__('Editar despesas nesta guia')}}"><i class="fas fa-plus"></i> {{__('Editar')}}</button>
            </div>
        </div>
    </div>
</div>
